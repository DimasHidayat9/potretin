const video = document.getElementById('webcam');
    ...
    // Dipanggil oleh tombol "Tampilkan QR" — merender ulang QR dari file terakhir
    // yang diunduh (strip/grid) di sesi ini, baru menampilkan panelnya.
    function revealQrPanel() {
      if (!lastExportedDataUrl) {
        showToast('Unduh strip atau grid dulu, baru bisa tampilin QR-nya ya.', 'ℹ️');
        return;
      }
